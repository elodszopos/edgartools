...
def _annual_report(report: Any) -> FormCAnnualReport | None:
    ...
    return FormCAnnualReport(
        current_employees=to_int(report.current_employees),
        total_asset_most_recent_fiscal_year=to_float(report.total_asset_most_recent_fiscal_year),
        total_asset_prior_fiscal_year=to_float(report.total_asset_prior_fiscal_year),
        cash_equi_most_recent_fiscal_year=to_float(report.cash_equi_most_recent_fiscal_year),
        cash_equi_prior_fiscal_year=to_float(report.cash_equi_prior_fiscal_year),
        act_received_most_recent_fiscal_year=to_float(report.act_received_most_recent_fiscal_year),
        act_received_prior_fiscal_year=to_float(report.act_received_prior_fiscal_year),
        short_term_debt_most_recent_fiscal_year=to_float(report.short_term_debt_most_recent_fiscal_year),
        short_term_debt_prior_fiscal_year=to_float(report.short_term_debt_prior_fiscal_year),
        long_term_debt_most_recent_fiscal_year=to_float(report.long_term_debt_most_recent_fiscal_year),
        long_term_debt_prior_fiscal_year=to_float(report.long_term_debt_prior_fiscal_year),
        revenue_most_recent_fiscal_year=to_float(report.revenue_most_recent_fiscal_year),
        revenue_prior_fiscal_year=to_float(report.revenue_prior_fiscal_year),
        cost_goods_sold_most_recent_fiscal_year=to_float(report.cost_goods_sold_most_recent_fiscal_year),
        cost_goods_sold_prior_fiscal_year=to_float(report.cost_goods_sold_prior_fiscal_year),
        tax_paid_most_recent_fiscal_year=to_float(report.tax_paid_most_recent_fiscal_year),
        tax_paid_prior_fiscal_year=to_float(report.tax_paid_prior_fiscal_year),
        net_income_most_recent_fiscal_year=to_float(report.net_income_most_recent_fiscal_year),
        net_income_prior_fiscal_year=to_float(report.net_income_prior_fiscal_year),
